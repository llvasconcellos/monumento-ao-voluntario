...
function mostramenu_leo(){ //Insere dentro do <div> menucursos a tabela abaixo:
	/*escondemenu();
	escondeselect();*/
	var html = 		'<table width="200" cellpadding="3" cellspacing="0" class="tabela_menu">'
				+	'<tr><td class="celulasubmenu"><a href="http://www.voluntariado.org.br" target="_blank" class="submenu">www.voluntariado.or.br</td></tr>'
				+	'<tr><td class="celulasubmenu"><a href="http://www.portaldovoluntario.org.br" target="_blank" class="submenu">www.portaldovoluntario.org.br</td></tr>'
				+	'<tr><td class="celulasubmenu"><a href="http://www.acaovoluntaria.org.br" target="_blank" class="submenu">www.acaovoluntaria.org.br</td></tr>'
				+	"</table>";
	...
	document.all["menuleo"].style.left = "135px";
